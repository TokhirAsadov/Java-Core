...
Java dasturida **token** bu eng kichik individual birlik bo‘lib, u kompilyator tomonidan tan olinadi (java kompilyatorga berilgan eng kichik birlik(unit)). Masalan: `int`, `x`, `=`, `10`, `;` bularning barchasi tokenlardir.
