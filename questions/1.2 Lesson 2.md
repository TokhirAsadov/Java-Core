...
Java dasturida **token** bu eng kichik individual birlik bo‘lib, u kompilyator tomonidan tan olinadi (java kompilyatorga berilgan eng kichik buyruq(unit)). Masalan: `int`, `x`, `=`, `10`, `;` bularning barchasi tokenlardir.
...
Java da **67 ta** keyword mavjud. Misol: `class`, `public`, `static`, `void`, `if`, `else`, `switch`, `return`, va h.k.
